...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mSoundPool = SoundPool(1, AudioManager.STREAM_MUSIC, 0)
        val soundId: Int = mSoundPool.load(this, R.raw.sound_alarm, 1)
        ...
        getResultText = registerForActivityResult(
            ...
            if(result.resultCode == RESULT_OK) {
                ...
                Toast.makeText(this, "${mString}분 ${sString}초가 지났습니다.", Toast.LENGTH_LONG).show()
            }
        }
